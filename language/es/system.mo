...
$lang['sys_tran_mess_owner'] 				= "Una de su flota llega a% s% s. El libro de las unidades de% s% s% s% s unidades y dependencias% s% s.";
...
$lang['sys_tran_mess_back'] 				= "Una flota de regreso% s% s. La flota no entrega los recursos.";

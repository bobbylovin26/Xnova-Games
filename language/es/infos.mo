...
$lang['info'][45]['name']          = "Super Terraformer";
$lang['info'][45]['description']  = "El super terraformer utiliza tecnologia mas avanzada, asi como maquinaria mas costosa para hacer habitable las zonas que ni el mismo terraformer podia conseguir.";
// ----------------------------------------------------------------------------------------------------------
// Laboratorio !

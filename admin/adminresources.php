	...
	switch($_GET[mode])
	{
		case'add_resources':
			...
			if ($mode == 'addit')
			{
				...
				message ("Recursos añadidos con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/add_resources"), $parse), "Admin CP - Añadir recursos", false, '', true, false);
		break;
		case'del_resources':
			$mode      = $_POST['mode'];
			if ($mode == 'addit')
			{
				...
				message ("Recursos eliminados con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/del_resources"), $parse), "Admin CP - Eliminar recursos", false, '', true, false);
		break;
		case'add_ships':
			$mode      = $_POST['mode'];
			if ($mode == 'addit')
			{
				...
				message ("Naves agregadas con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/add_ships"), $parse), "Admin CP - Añadir naves", false, '', true, false);
		break;
		case'del_ships':
			$mode      = $_POST['mode'];
			if ($mode == 'addit')
			{
				...
				message ("Naves eliminadas con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/del_ships"), $parse), "Admin CP - Eliminar naves", false, '', true, false);
		break;
		case'add_defenses':
			$mode      = $_POST['mode'];
			if ($mode == 'addit')
			{
				...
				message ("Defensas añadidas con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/add_defenses"), $parse), "Admin CP - Añadir defensas", false, '', true, false);
		break;
		case'del_defenses':
			$mode      = $_POST['mode'];
			if ($mode == 'addit')
			{
				...
				message ("Defensas eliminadas con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/del_defenses"), $parse), "Admin CP - Eliminar defensas", false, '', true, false);
		break;
		case'add_buildings':
			$mode      = $_POST['mode'];
			if ($mode == 'addit')
			{
				...
				message ("Edificios añadidos con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/add_buildings"), $parse), "Admin CP - Añadir edificios", false, '', true, false);
		break;
		case'del_buildings':
			$mode      = $_POST['mode'];
			if ($mode == 'addit')
			{
				...
				message ("Edificios eliminados con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/del_buildings"), $parse), "Admin CP - Eliminar edificios", false, '', true, false);
		break;
		case'add_research':
			$mode      = $_POST['mode'];
			if ($mode == 'addit')
			{
				...
				message ("Investigaciones añadidas con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/add_research"), $parse), "Admin CP - Añadir investigaciones", false, '', true, false);
		break;
		case'del_research':
			$mode      = $_POST['mode'];
			if ($mode == 'addit')
			{
				...
				message ("Investigaciones eliminadas con éxito","¡Listo!","adminresources.php",2);
			}
			display (parsetemplate(gettemplate("admin/del_research"), $parse), "Admin CP - Eliminar investigaciones", false, '', true, false);
		break;
		default:
			display(parsetemplate(gettemplate('admin/adminresources'), $parse), "Añadir/Eliminar recursos y tecnologías", false, '', true, false);
	}
}
else
{

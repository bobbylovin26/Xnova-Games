...
//Generic
	...
	*/
	...
	$Page .= "D&eacute:soler, c'est rapport ne peut pas &ecirc;tre copier.";
	$Page .= "<br /><br />";
	$Page .= "</center>";
	$Page .= "</body>";
	$Page .= "</html>";
...
// Now its Sonyedorlys input form. Many thanks for allowing me to use it. (Slightly edited)
	...
	$page = "<form action='simulator.php' method='post'><center><table><tr><td>Simulador de Batallas<br />";
	$page .= "<table border=1 width=100%><tr><td class=\"c\">&nbsp;</td><td class=\"c\"> Atacante </td><td class=\"c\"> Defensor </td></tr>";
	$page .= "<tr><td class=\"c\" colspan=\"3\"> Tecnologias </td></tr>";
	$page .= "<tr><th> Militar </th><th><input type='text' name='military_tech_us[1]' value='".$parse['military']."'></th><th><input type='text' name='military_tech_them[0]' value='".$parse[109]."'></th></tr>";
	$page .= "<tr><th> Defensa </th><th><input type='text' name='defence_tech_us[1]' value='".$parse['defence']."'></th><th><input type='text' name='defence_tech_them[0]' value='".$parse[110]."'></th></tr>";
	$page .= "<tr><th> Blindaje </th><th><input type='text' name='shield_tech_us[1]' value='".$parse['shield']."'></th><th><input type='text' name='shield_tech_them[0]' value='".$parse[111]."'></th></tr>";
	for ($SetItem = 200; $SetItem < 500; $SetItem++) {
	...
	$page .= "<tr><td class=\"c\" colspan=\"3\"> Recursos </td></tr>";
	$page .= "<tr><th> Metal </th><th>&nbsp;</th><th><input type='text' name='metal' value='".$parse['metal']."'></th></tr>";
	$page .= "<tr><th> Cristal </th><th>&nbsp;</th><th><input type='text' name='crystal' value='".$parse['crystal']."'></th></tr>";
	$page .= "<tr><th> Deuterio </th><th>&nbsp;</th><th><input type='text' name='deuterium' value='".$parse['deuterium']."'></th></tr>";
	$page .= "<tr><th colspan='3'><input type='submit' name='submit' value='Simular'></th></tr>";
	$page .= "</table></center></form>";
	display($page, "Simulador de Batallas", false);
}

...
<table width="400">
<tbody>
	<td class="c" colspan="7">Eliminar niveles de investigación</td>
</tr><tr>
	...
	<th>15</td>
	<th>Tecnología de expedición</td>
	...
	<th colspan="3"><input type="Submit" value="Eliminar niveles" /></th>
</tbody>
</tr>
</table>
</form>
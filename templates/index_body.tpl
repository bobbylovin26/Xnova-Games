    ...
    <div id="login">
        <div id="login_input">
            ...
            <tr style="vertical-align: top;">
                ...
                <td style="padding-right: 4px;">
                    Recordar Contraseña <input name="rememberme" type="checkbox"><input name="submit" value="Ingresar" type="submit">
                </td>
            </tr><tr>
                <td style="padding-right: 4px;"><a href="index.php?modo=claveperdida">¿Olvidaste tu Contraseña?</a></td>
            </tr>
            </tbody>
            </table>
            </form>
